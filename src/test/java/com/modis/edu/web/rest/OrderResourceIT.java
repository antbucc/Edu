...
class OrderResourceIT {
    ...
    public static Order createEntity() {
        Order order = new Order().order(DEFAULT_ORDER);
        return order;
    }
    ...
    public static Order createUpdatedEntity() {
        Order order = new Order().order(UPDATED_ORDER);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getOrder()).isEqualTo(DEFAULT_ORDER);
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.order(UPDATED_ORDER);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getOrder()).isEqualTo(UPDATED_ORDER);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.order(UPDATED_ORDER);
