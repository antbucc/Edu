...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sequence.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEQUENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEQUENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEQUENCE actions', async () => {
      const expectedActions = [
        {
