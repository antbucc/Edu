...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETOFFRAGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SETOFFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SETOFFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SETOFFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SETOFFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SETOFFRAGMENT actions', async () => {
      const expectedActions = [
        {
