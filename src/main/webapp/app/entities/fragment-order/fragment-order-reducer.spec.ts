...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAGMENTORDER_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRAGMENTORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRAGMENTORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRAGMENTORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRAGMENTORDER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRAGMENTORDER actions', async () => {
      const expectedActions = [
        {
