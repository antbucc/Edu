...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDTOPIC_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDTOPIC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDTOPIC actions', async () => {
      const expectedActions = [
        {
