...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './set-of.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETOF_LIST actions', async () => {
    ...
    it('dispatches FETCH_SETOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SETOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SETOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SETOF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SETOF actions', async () => {
      const expectedActions = [
        {
