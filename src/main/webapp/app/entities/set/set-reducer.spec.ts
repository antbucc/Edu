...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SET_LIST actions', async () => {
    ...
    it('dispatches FETCH_SET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SET actions', async () => {
      const expectedActions = [
        {
