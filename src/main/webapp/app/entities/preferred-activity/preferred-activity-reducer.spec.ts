...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './preferred-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDACTIVITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDACTIVITY actions', async () => {
      const expectedActions = [
        {
