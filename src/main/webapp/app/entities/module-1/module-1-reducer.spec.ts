...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './module-1.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODULE1_LIST actions', async () => {
    ...
    it('dispatches FETCH_MODULE1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODULE1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODULE1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODULE1 actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODULE1 actions', async () => {
      const expectedActions = [
        {
