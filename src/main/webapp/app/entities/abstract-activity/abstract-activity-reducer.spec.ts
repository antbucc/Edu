...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './abstract-activity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABSTRACTACTIVITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ABSTRACTACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ABSTRACTACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ABSTRACTACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ABSTRACTACTIVITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ABSTRACTACTIVITY actions', async () => {
      const expectedActions = [
        {
