...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './preferred-modality.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDMODALITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDMODALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDMODALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDMODALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDMODALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDMODALITY actions', async () => {
      const expectedActions = [
        {
