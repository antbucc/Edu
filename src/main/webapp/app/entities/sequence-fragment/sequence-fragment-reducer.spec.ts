...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sequence-fragment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEQUENCEFRAGMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEQUENCEFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEQUENCEFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEQUENCEFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEQUENCEFRAGMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEQUENCEFRAGMENT actions', async () => {
      const expectedActions = [
        {
