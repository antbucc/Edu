    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {fragmentEntity.abstractActivities
              ? fragmentEntity.abstractActivities.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.title}</a>
                    {fragmentEntity.abstractActivities && i === fragmentEntity.abstractActivities.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
