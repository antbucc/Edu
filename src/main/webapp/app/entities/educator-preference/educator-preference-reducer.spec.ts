...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './educator-preference.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDUCATORPREFERENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EDUCATORPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EDUCATORPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EDUCATORPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EDUCATORPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EDUCATORPREFERENCE actions', async () => {
      const expectedActions = [
        {
