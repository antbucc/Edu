            ...
            <tbody>
              {educatorPreferenceList.map((educatorPreference, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{educatorPreference.subject}</td>
                  <td>
                    <Translate contentKey={`eduApp.Difficulty.${educatorPreference.difficulty}`} />
                  </td>
                  <td>
                    {educatorPreference.eductarPreferences ? (
                      <Link to={`/educator/${educatorPreference.eductarPreferences.id}`}>{educatorPreference.eductarPreferences.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
