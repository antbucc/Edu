...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './learning-disability.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNINGDISABILITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEARNINGDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEARNINGDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEARNINGDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEARNINGDISABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEARNINGDISABILITY actions', async () => {
      const expectedActions = [
        {
