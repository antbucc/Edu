...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './learner-preference.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNERPREFERENCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEARNERPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEARNERPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEARNERPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEARNERPREFERENCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEARNERPREFERENCE actions', async () => {
      const expectedActions = [
        {
