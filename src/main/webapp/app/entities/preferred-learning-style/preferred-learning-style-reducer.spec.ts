...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './preferred-learning-style.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDLEARNINGSTYLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDLEARNINGSTYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDLEARNINGSTYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDLEARNINGSTYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDLEARNINGSTYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDLEARNINGSTYLE actions', async () => {
      const expectedActions = [
        {
