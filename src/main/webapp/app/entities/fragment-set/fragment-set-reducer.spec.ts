...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAGMENTSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_FRAGMENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FRAGMENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FRAGMENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FRAGMENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FRAGMENTSET actions', async () => {
      const expectedActions = [
        {
