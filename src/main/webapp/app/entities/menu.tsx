...
const EntitiesMenu = () => {
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/set">
        <Translate contentKey="global.menu.entities.set" />
      </MenuItem>
      ...
      <MenuItem icon="asterisk" to="/set-of-fragment">
        <Translate contentKey="global.menu.entities.setOfFragment" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/order">
        <Translate contentKey="global.menu.entities.order" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/fragment-order">
        <Translate contentKey="global.menu.entities.fragmentOrder" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/fragment-set">
        <Translate contentKey="global.menu.entities.fragmentSet" />
      </MenuItem>
