...
public class FragmentResource {
    ...
    public List<Fragment> getAllFragments(
        ...
        if ("abstractactivity-is-null".equals(filter)) {
            log.debug("REST request to get all Fragments where abstractActivity is null");
            return StreamSupport
                .stream(fragmentRepository.findAll().spliterator(), false)
                .filter(fragment -> fragment.getAbstractActivity() == null)
